...
void Features::cashdrop2(Player target)
{
	...
	if ((timeGetTime() - Features::TimePD2) > 1000) // Time between drops
	{
...
void Features::StealthDrop(int amount)
{
	...
	UNK3::_NETWORK_SHOP_BEGIN_SERVICE(&idk, 1474183246, 1982688246, 1445302971, amount, 1);
...
void Features::StealthLoop(bool toggle) {
	...
	{
		Any idk = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1000000000, 2999999999);
		UNK3::_NETWORK_SHOP_BEGIN_SERVICE(&idk, 1474183246, 1982688246, 1445302971, 90000000, 1);
		UNK3::_NETWORK_SHOP_CHECKOUT_START(idk);
...
void Features::maxvehicle()
{
	...
	VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(vehicle, "Galaxy");
}
...
void Features::StealthDropinte() {
	if ((timeGetTime() - Features::TimePD5) > 500)
	{
		if (amount > 0) {
			Any idk = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1000000000, 2999999999);
			UNK3::_NETWORK_SHOP_BEGIN_SERVICE(&idk, 1474183246, 1982688246, 1445302971, Features::amount, Features::banked ? 4 : 1);
			UNK3::_NETWORK_SHOP_CHECKOUT_START(idk);
		}
		else if (amount < 0) {
			Any izmon = 2147483647;
			if (UNK3::_NETWORK_SHOP_BEGIN_SERVICE(&izmon, 1474183246, 454359403, 537254313, Features::amount, Features::banked ? 4 : 1)) {
				UNK3::_NETWORK_SHOP_CHECKOUT_START(izmon);
			}
		}
		Features::TimePD5 = timeGetTime();
